...
{
   "peer_name": "peer0.example.sust.edu",
   "channelid": "mychannel",
   "use_couchdb":false,
...
async function main() {
    try {
        ...
        const walletPath = path.join(process.cwd(), '../../api-2.0/sust-wallet/');
        ...
        // const ccpPath = path.resolve(__dirname, '..', 'first-network', 'connection-sust.json');
        const ccpPath = '../../api-2.0/config/connection-sust.json'
        ...
        const network = await gateway.getNetwork('channelbeta');
